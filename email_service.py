...
class EmailService:
    ...
    def send_contact_notification(contact_message):
        ...
        try:
            ...
            logger.info(
                f"Contact notification sent successfully to {current_app.config['ADMIN_EMAIL']}"
            )
            return True
            ...
            EmailService._log_email(
                ...
                email_type='notification',
                subject=subject
                if 'subject' in locals() else 'رسالة جديدة من موقع موئل',
                status='failed',
                error_message=str(e))
    ...
    def send_welcome_email(contact_message):
        ...
        try:
            ...
            # Log success
            EmailService._log_email(contact_message_id=contact_message.id,
            ...
            logger.info(
                f"Welcome email sent successfully to {contact_message.email}")
            return True
            ...
            EmailService._log_email(
                ...
                'شكراً لتواصلك مع موئل للتمثيل القانوني',
                status='failed',
                error_message=str(e))
    ...
    @staticmethod
    def _log_email(contact_message_id,
                   recipient_email,
                   email_type,
                   subject,
                   status,
        ...
        try:
            email_log = EmailLog(contact_message_id=contact_message_id,
